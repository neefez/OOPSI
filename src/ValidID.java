...
public class ValidID extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
       ...
       Department dep = (Department)StartFrame.depList.getFromIndex(
                                                           StartFrame.index);
       boolean valid = false;
       ChooseRole.invalid = true;
       ChooseRole.backup = false;
       ...
       {    
          try
          {
             valid = DepartmentManagement.idCheck(validID);     
          }
          catch(InputMismatchException e)
          {
             ...
             this.setVisible(false);
             valid = false;
             validID = Bag.NOT_FOUND;      
          }    
        
          if(!valid)
          {
             validID = BackupID.getNewID(); 
          }         
       }      
       ...
       {    
          validID = Integer.parseInt(tempID);
          AddPerson.setID(validID);
          dep.numPeople++;
          new ChooseRole().setVisible(true);
          ChooseRole.id = validID;
          this.setVisible(false);
       }
